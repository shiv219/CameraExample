...
//        String cmd = "-threads 2 -y -i " + inputFile + " -strict -2 -vcodec libx264 -preset ultrafast -crf 24 -acodec copy -ac 2 -b:a 12k -s 640x352 " + outputFile;
//        String[] command = cmd.split(" ");
        String cmd = "-threads 2 -y -i " + inputFile + " -strict -2 -vcodec libx264 -preset ultrafast -crf 24 -acodec copy -ac 2 -b:a 12k -s 256x144 -aspect 4:3 " + outputFile;
        String[] command = cmd.split(" ");
        try {
