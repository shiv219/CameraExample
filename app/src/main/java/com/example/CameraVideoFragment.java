...
public abstract class CameraVideoFragment extends BaseFragment {
    ...
    private String[] mPermissions = {Manifest.permission.CAMERA, Manifest.permission.RECORD_AUDIO,Manifest.permission.ACCESS_MEDIA_LOCATION/*, Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE*/};
        ...
        switch (requestCode) {
            case PERMISSION_REQUEST_CODE:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    // Utility.toast(getActivity(), getString(R.string.permission_not_granted), Toast.LENGTH_SHORT);
                }
                break;
        }
    }
...
//        File dir = Utility.createDir(Constants.DIR_DO_NO_DELETE);
        ...
        File mediaFile = getOutputMediaFile(getContext());
        Log.d("mediaFile",mediaFile.toString());
        return mediaFile;
    }
    ...
    private void setUpMediaRecorder() throws IOException {
         ...
         */
        mCurrentFile = settingFileStructure();
        /**
