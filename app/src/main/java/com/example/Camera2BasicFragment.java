...
public class Camera2BasicFragment extends BaseFragment
    ...
    private Group vViewerGroup, vPictureGroup;
...
//            mBackgroundHandler.post(new ImageSaver(reader.acquireNextImage(), mFile));
    ...
    public static Camera2BasicFragment newInstance(OnMediaSubmit onMediaSubmit) {
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        vViewerGroup = view.findViewById(R.id.imageViewerGroup);
        vPictureGroup = view.findViewById(R.id.pictureRecorderGroup);
        vImageViewer = view.findViewById(R.id.imageViewer);
        vCross = view.findViewById(R.id.close);
        vDone = view.findViewById(R.id.done);
        vRetake = view.findViewById(R.id.retake);
        vCaptureImage = view.findViewById(R.id.captureImage);
        setOnClickListener();
    }
    ...
    private void setOnClickListener() {
        ...
        vCaptureImage.setOnClickListener(this);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.done: {
                onMediaSubmit.onMediaSubmit(mFile.getAbsolutePath());
                break;
            }
            case R.id.close: {
...
//        File mediaFile = Utility.createFile(fileName);
    ...
    @UiThread
    private void saveFile(Image mImage) {
        ByteBuffer buffer = mImage.getPlanes()[0].getBuffer();
        byte[] bytes = new byte[buffer.remaining()];
        buffer.get(bytes);
        FileOutputStream output = null;
        ...
        showImageViewer(bytes);
    }

    private void showImageViewer(byte[] bytes) {
...
//                vImageViewer.setRotation(90);
    ...
    private void retake() {
        deleteTheFile(mFile.getAbsolutePath());
        vPictureGroup.setVisibility(View.VISIBLE);
        vViewerGroup.setVisibility(View.GONE);
        if (mTextureView.isAvailable()) {
            openCamera(mTextureView.getWidth(), mTextureView.getHeight());
        } else {
            mTextureView.setSurfaceTextureListener(mSurfaceTextureListener);
    ...
    private void deleteTheFile(String absolutePath) {
        try {
