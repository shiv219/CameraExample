...
public class RecordVideoPostsActivity extends AppCompatActivity implements
    ...
    private TextView iv_cancel, iv_ok, iv_record;
    ...
    private void initView() {
        ...
        iv_record = (TextView) findViewById(R.id.iv_record);
...
//                mMediaRecorder.setAudioEncoder(MediaRecorder.AudioEncoder.AAC);
    ...
    private void startRecord() {
        try {
            if (initVideoRecorder()) {
                ...
                iv_record.setText("STOP");
            } else {
                releaseMediaRecorder();
                iv_record.setText("START");
            }
    ...
    private File setUpVideoFile(Context context) throws IOException {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment
            ...
            File storageDir = new File(context.getFilesDir(), "HOME_HUB");
            ...
            videoFile = File.createTempFile(File.separator +
                    "VID_" + timeStamp + ".mp4", storageDir.getAbsolutePath());
        } else {
